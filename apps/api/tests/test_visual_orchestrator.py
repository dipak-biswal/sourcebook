...
import app.agents.visual_summary.tools as visual_tools_mod
from app.agents.main.runner.lifecycle import _run_visual_summary_agent
from app.agents.visual_summary.pipeline import _run_visual_pipeline
...
def test_pipeline_token_usage_counts_embedded_llm_tokens(
    ...
    monkeypatch.setattr("app.agents.visual_summary.pipeline.run_plan_layout", fake_plan)
    monkeypatch.setattr(
        "app.agents.visual_summary.pipeline.run_render_ui",
        lambda *a, **k: {
            "status": "rendered",
