...
from app.agents.tools.date import DATE_TOOL_NAMES, current_date_payload, get_current_date
from app.agents.tools.fetch_url import fetch_url_content, validate_fetch_url
...
def __getattr__(name: str):
    ...
    if name == "build_tools":
        from app.agents.tools.factory import build_tools
