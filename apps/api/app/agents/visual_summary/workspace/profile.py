...
from app.agents.visual_summary.handoff.structured import _BLOCK_MENU, _SOURCE_HINT_BLOCK_TYPE
from app.agents.visual_summary.planning.ui_intent import _AFFORDANCE_SPEC, KNOWN_SOURCE_HINTS
